...
insert into Recipe (recipe_name,recipe_instructions,method_id,ingredient_id,recipecuisine_id, date_created) values ('Eves Downfall',	'Prepare all ingredients so that they will fit into the feed chute of the juicer. Either juice immediately, or vacuum seal & refridgerate for later use.',	3,4,4,CURDATE());
